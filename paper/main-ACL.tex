...
%  ACL-formatted paper, single-column (= "preprint" style on ACL template).
%  For double-blind submission, replace \usepackage{acl} with
...
\usepackage{acl}                 % ACL 2023+ style file (provides margins,
                                 % fonts, references, theorem env, etc.)
\usepackage{times}
\usepackage{latexsym}
